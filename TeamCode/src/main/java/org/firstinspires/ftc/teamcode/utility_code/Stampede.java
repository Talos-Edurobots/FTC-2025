...
//orf
    ...
    public void initWheelHardware(boolean withEncoder) {
        ...
        driveFrontLeft = setUpEncoderMotor("left_front", DcMotor.Direction.REVERSE, 12, 10, 0.0, 5.0, withEncoder); //orf lf FORWARD
        driveFrontRight = setUpEncoderMotor("right_front", DcMotor.Direction.FORWARD, 12, 10, 0.0, 5.0, withEncoder); //orf rf
        driveRearLeft = setUpEncoderMotor("left_back", DcMotor.Direction.REVERSE, 12, 10, 0.0, 5.0, withEncoder); // orf lr FORWARD
        driveRearRight = setUpEncoderMotor("right_back", DcMotor.Direction.FORWARD, 12, 10, 0.0, 5.0, withEncoder); // rr REVERSE
    ...
    public void init(HardwareMap ahwMap) {
        ...
        if (true) {
            ...
            configureOtos(0, 0, 0, 3600.0 / (3600.0), 96.0 / 96.0);
